        ...
        <div class="auto-container">
            ...
            <div class="row">
                <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "600" :{ "items" : "1" }, "768" :{ "items" : "2" } , "992":{ "items" : "2" }, "1200":{ "items" : "3" }}}'>
                    ...
                    <div class="testimonial-block-two">
                        <div class="inner-box">
                            <div class="text">Sipariş oluşturmadan teklif sürecine kadar iletişim konusunda herhangi bir sorun yaşamadık. Destekleri için teşekkürler.
                            </div>
                            <h4>John Smith  <span>Üretim Müdürü</span></h4>
                            <div class="author-thumb">
                    ...
                    <div class="testimonial-block-two">
                        <div class="inner-box">
                            ...
                            <h4>Christine eve <span>İnsan Kaynakları</span></h4>
                            <div class="author-thumb">
                                ...
                                <div class="column counter-column col-md-4">
                                    <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                        <div class="content">
                                            ...
                                            <div class="fact-text"> Biten <br> Projelerimiz</div>
                                        </div>
                                    </div>
                                </div>
                                <!--Column-->
                                <div class="column counter-column col-md-4">
                                    <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                        <div class="content">
                                            ...
                                            <div class="fact-text"> Müşteri <br> Memnuniyeti</div>
                                        </div>
                                    </div>
                                </div>
                                <!--Column-->
                                <div class="column counter-column col-md-4">
                                    <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                        <div class="content">
                                            ...
                                            <div class="fact-text">Uzman  <br> Ekip</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
