...
@include('layouts.header')
    ...
    <!-- Page Title -->
    <section class="page-title" style="background-image: url(assets/images/resource/HUZEY-METAL-İLETİSİM-SLDİER.jpeg);">
                ...
                <div class="col-lg-4">
                    <div class="contact-details mb-30">
                        <div class="sec-title mb-40">
                            <div class="sub-title">Sizin İçin Buradayız</div>
                            <h2>BİZE <br>  ULAŞABİLİRSİNİZ</h2>
                        </div>
                        <div class="text mb-40">Hizmetlerimiz hakkında, tedarik süreci ve diğer tüm konularda detaylı bilgi almak için 7/24 bizimle iletişime geçebilirsiniz.</div>
                        <div class="contact-info">
                            <div class="icon-box">
                                <div class="icon"><span class="flaticon-calling"></span></div>
                                <div class="content">
                                    <h5>Hemen Ara</h5>
                                    <div class="text"><a href="tel:+902167478006">+90 (216) 747 80 06</a></div>
                                </div>
                            </div>
                            <div class="icon-box">
                                <div class="icon"><span class="flaticon-calling"></span></div>
                                <div class="content">
                                    <h5>Hemen Ara</h5>
                                    <div class="text"><a href="tel:+905445073848">+90 (544) 507 38 48</a></div>
                                </div>
                            </div>
                            <div class="icon-box">
                            ...
                            <div class="icon-box">
                                ...
                                <div class="content">
                                    <h5>Fİrma Adres</h5>
                                    <div class="text">Velibaba Mh.Mimarsinan Cd.No:1 Pendik/İST.</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="contact-form">
                <form method="post" action="https://html.tonatheme.com/2022/welbim/inc/sendemail.php" id="contact-form">
                    <div class="row row-20">
                        ...
                        <div class="form-group col-md-6">
                            <input type="text" name="form_name" value="" placeholder="Göreviniz" required>
                        </div>
                        <div class="form-group col-md-6">
                            <input type="text" name="form_name" value="" placeholder="Firma Adı" required>
                        </div>
                        <div class="form-group col-md-6">
                            <input type="text" name="email" value="" placeholder="E Posta Adresiniz" required>
                        </div>
                        <div class="form-group col-md-6">
                            <input type="text" name="form_phone" value="" placeholder="Telefon Numaranız" required>
                        </div>
                        <div class="form-group col-md-6">
                            <input type="text" name="form_subject" value="" placeholder="Konu" required>
                        </div>
                        ...
                        <div class="form-group text-center col-md-12">
                            ...
                            <button class="theme-btn btn-style-one" type="submit" data-loading-text="Please wait..."><span>GÖNDER</span></button>
                        </div>
                    </div>
                </form>
            </div>
