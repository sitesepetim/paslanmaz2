...
@section('title')
    430 Paslanmaz Sac Fiyatları |  Huzey Metal
@endsection
...
@section('content')
        ...
        <div class="auto-container">
            <div class="content-box">
                <div class="content-wrapper">
                    <div class="title">
                        <h1>430 PASLANMAZ SAC FİYATLARI</h1>
                    </div>
                    <ul class="bread-crumb">
                        <li><a href="{{route('index')}}">ANA SAYFA</a></li>
                        <li><a href="{{route('fiyat_listesi')}}">FİYAT LİSTESİ</a></li>
                        <li>430 PASLANMAZ SAC FİYATLARI</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="project-details">
        <div class="auto-container">
            <div class="image mb-40"><img src="{{asset('assets/images/resource/430 Paslanmaz Sac Fİyatları.jpg')}}" alt=""></div>
            <div class="row">
                @include('page.fiyat.sidebar')
                <div class="col-lg-9">
                    <h2>430 Paslanmaz Sac Fİyatları</h2>
                    ...
                    <br>
                    <br>
                    <h3>430 Paslanmaz Sac FİYAT LİSTESİ</h3>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                        @for($i=0;$i<\App\Models\fiyatListesi::where('type','=',"430_sac")->count();$i++)
                        <tr>
                            <th scope="row">{{$i+1}}</th>
                            <td>{{\App\Models\fiyatListesi::where('type','=',"430_sac")->get()[$i]['kalite']}}</td>
                            <td>{{\App\Models\fiyatListesi::where('type','=',"430_sac")->get()[$i]['kalinlik']}}</td>
                            <td>{{\App\Models\fiyatListesi::where('type','=',"430_sac")->get()[$i]['ebat']}}</td>
                            <td>{{\App\Models\fiyatListesi::where('type','=',"430_sac")->get()[$i]['kg']}}</td>
                            <td>${{\App\Models\fiyatListesi::where('type','=',"430_sac")->get()[$i]['birim']}}</td>
                            <td>${{\App\Models\fiyatListesi::where('type','=',"430_sac")->get()[$i]['plaka']}}</td>
                        </tr>
                        @endfor
                        </tbody>
                    </table>
