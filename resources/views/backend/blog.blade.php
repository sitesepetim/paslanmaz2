                    ...
                    <div class="col-xxl-12">
                        ...
                        <div class="card card-xxl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                ...
                                <a href="{{route('admin.blog.create')}}"> <button  class="btn btn-success"><span style="font-size: 25px">+ Blog Ekle</span> </button></a>
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table id="tables2" class="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
                                                ...
                                                <tr>
                                                    ...
                                                    @endif
                                                    <td class="">
                                                        <a href="{{route('admin.blog.update',['id'=>$value['id']])}}">    <button  class="btn btn-primary"> Düzenle</button></a>
