                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Fiyat Ekleme</h3>
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{route('fiyat_creates')}}" id="kt_account_profile_details_form" class="form">
                            <!--begin::Card body-->
                            @csrf
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Excel</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <!--begin::Row-->
                                        <div class="row">
                                            <!--begin::Col-->
                                                ...
                                                <input type="text" hidden name="type" value="{{$_GET['type']}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"  />
                                            <!--end::Col-->
                                            <!--begin::Col-->
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">İçeri Aktar</button>
                            </div>
                            <!--end::Actions-->
                        </form>
                        <!--end::Form-->
