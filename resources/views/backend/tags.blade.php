...
@section('content')
    ...
    @if(session('kategories'))
        ...
        <script>swal("Etiket Eklendi","Tebrikler Etiket Başarı İle Eklendi....", "success");</script>
    ...
    @if(session('kategories_edit'))
        ...
        <script>swal("Etiket Düzenlendi","Tebrikler Etiket Başarı İle Güncellendi....", "success");</script>

    @endif

    @if(session('kategories_delete'))

        <script>swal("Etiket Silindi","Etiket Başarı İle Silindi....", "success");</script>
                ...
                <div class="row g-5 g-xxl-8">
                    ...
                    <div hidden id="ekleme" class="card mb-5 mb-xl-10">
                        ...
                        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                            ...
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0">Etiket Ekleme</h3>
                            </div>
                            <!--end::Card title-->
                        </div>
                        <!--begin::Card header-->
                        ...
                        <div id="kt_account_profile_details" class="collapse show">
                            <!--begin::Form-->
                            <form method="post" action="{{route('store_tags')}}" id="kt_account_profile_details_form" class="form">
                                <!--begin::Card body-->
                                @csrf
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="row mb-6">
                                        <!--begin::Label-->
                                        <label class="col-lg-4 col-form-label required fw-bold fs-6">Etiket İsmi</label>
                                        <!--end::Label-->
                                        <!--begin::Col-->
                                        <div class="col-lg-8">
                                            <!--begin::Row-->
                    ...
                    <div hidden  id="duzenleme" class="card mb-5 mb-xl-10">
                        ...
                        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
                            <!--begin::Card title-->
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0">Etiket Düzenleme</h3>
                            </div>
                            <!--end::Card title-->
                        </div>
                        <!--begin::Card header-->
                        ...
                        <div id="kt_account_profile_details" class="collapse show">
                            <!--begin::Form-->
                            <form method="post" action="{{route('tags_categories')}}" id="kt_account_profile_details_form" class="form">
                                <!--begin::Card body-->
                                @csrf
                                <div class="card-body border-top p-9">
                                    <!--begin::Input group-->
                        ...
                        <div class="card card-xxl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-header border-0 pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Etiket Listesi</span>
                                </h3>
                             <button id="kategori"  onclick="categories_show()" class="btn btn-success"><span style="font-size: 25px">+ Etiket Ekle</span> </button>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
                                                ...
                                                <tr class="border-0">
                                                    ...
                                                    <th class="p-0 min-w-150px">Etiket Başlığı</th>
                                                        ...
                                                        <script>
                                                            ...
                                                            function delete_categories(val){
                                                                Swal.fire({
                                                                    ...
                                                                    text: "Etiket Silinecek Eminmisiniz?",
                                                                    icon: 'warning',
