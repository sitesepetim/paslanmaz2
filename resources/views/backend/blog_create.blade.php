            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form enctype="multipart/form-data" method="post" action="{{route('blog_create')}}" id="kt_account_profile_details_form" class="form">
                            <!--begin::Card body-->
                            @csrf
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <textarea name="meta_desc" class="form-control" id="" cols="20" rows="5"></textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
