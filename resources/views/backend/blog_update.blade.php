                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" aria-expanded="true" aria-controls="kt_account_profile_details">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Blog Düzenleme</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form enctype="multipart/form-data" method="post" action="{{route('store_update')}}" id="kt_account_profile_details_form" class="form">
                            <!--begin::Card body-->
                            @csrf
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-lg-4">
                                    <label class="d-block fw-bold fs-6 mb-5">Blog Resmi</label>
                                    </div>
                                    <!--end::Label-->
                                    <!--begin::Image input-->
                                    <div class="col-lg-8 ">
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{asset('public/'.$data['image_path'])}})">
                                        <!--begin::Preview existing avatar-->
                                        <div class="image-input-wrapper w-250px h-250px" style="background-image: url({{asset('public/'.$data['image_path'])}});"></div>
                                        <!--end::Preview existing avatar-->
                                        <!--begin::Label-->
                                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="" data-bs-original-title="Resmi Değiştir">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Cancel-->
                                        <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="cancel" data-bs-toggle="tooltip" title="" data-bs-original-title="Resmi İptal Et">
																				<i class="bi bi-x fs-2"></i>
																			</span>
                                        <!--end::Cancel-->
                                        <!--begin::Remove-->
                                        <span class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="remove" data-bs-toggle="tooltip" title="" data-bs-original-title="Resmi Sil">
																				<i class="bi bi-x fs-2"></i>
																			</span>
                                        <!--end::Remove-->
                                    </div>
                                    <!--end::Image input-->
                                    <!--begin::Hint-->
                                    <div class="form-text">İzin Verilen Resim Uzantıları: png, jpg, jpeg.</div>
                                    </div>
                                    <!--end::Hint-->
                                </div>
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Blog Başlığı</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <!--begin::Row-->
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="name" value="{{$data['title']}}" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Blog Başlığı"  />
                                            </div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <textarea name="content" id="kt_docs_ckeditor_classic">{{$data['content']}}</textarea>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Meta Açıklaması</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <textarea name="meta_desc" class="form-control" id="" cols="20" rows="5">{{$data['meta_desc']}}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                                        <span class="required">Kategori Seçimi</span>
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Kategori Seçimi Gereklidir."></i>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">

                                        <select name="categories" class="form-control form-control-solid" id="">

                                            @foreach(\App\Models\categories::where('status','=',1)->get() as $key => $value )
                                                <option {{$data['categories']==$value['id'] ? "selected":""}} value="{{$value['id']}}">{{$value['name']}}</option>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <select multiple name="tags[]" class="form-control form-control-solid" id="tags_check">
                                            @foreach(\App\Models\tags::where('status','=',1)->get() as $key => $value )
                                                <option   {{$data['tags']==$value['id'] ? "selected":""}} value="{{$value['id']}}">{{$value['name']}}</option>
