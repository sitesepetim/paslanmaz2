                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" aria-expanded="true" aria-controls="kt_account_profile_details">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Blog Ekleme</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form enctype="multipart/form-data" method="post" action="{{route('blog_create_post_spin')}}" id="kt_account_profile_details_form" class="form">
                            <!--begin::Card body-->
                            @csrf
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-7">
                                    ...
                                    <!--begin::Image input-->
                                    <div class="col-lg-8 ">
                                        <button @click="addList()" type="button" class="btn btn-success">+ ekle</button>
                                        <div class="image-input image-input-outline" v-for="(list,index) in datayer2" data-kt-image-input="true" style="background-image: url({{asset('assets/media/avatars/blank.png')}});margin: 5px">
                                            ...
                                            <!--end::Cancel-->
                                            <!--begin::Remove-->
                                            <span @click="deleteList(index)" class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="remove" data-bs-toggle="tooltip" title="" data-bs-original-title="Resmi Sil">
																				<i class="bi bi-x fs-2"></i>
																			</span>
                                            <!--end::Remove-->
                                        </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                                        <span class="required">İçerik Seçimi</span>
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <select name="blog_id" class="form-control form-control-solid" id="">
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                                        <span class="required">Bölge Seçimi</span>
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Kategori Seçimi Gereklidir."></i>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        ...
                                        <select name="il_id" class="form-control form-control-solid" id="">

                                            <option value="0">Tüm Türkiye</option>
                                            @foreach(\App\Models\iller::all() as $key => $value )

                                                <option value="{{$value['id']}}">{{$value['il_adi']}}</option>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Değiştirilecek Anahtar Kelime</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Blog Başlığı"  />
                                            </div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
    ...
    <script>
        ...
        createApp({
            ...
            methods: {
                ...
                deleteList(index){
                    if(this.datayer2.length>1){
                        this.datayer2.splice(index,1);
