            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        <!--begin::Form-->
                        <form enctype="multipart/form-data" method="post" action="{{route('store_ai')}}" id="kt_account_profile_details_form" class="form">
                            <!--begin::Card body-->
                            @csrf
                            ...
                            <div class="card-body border-top p-9">
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Blog Resim</label>
                                    <div class="col-lg-8">
                                        <div class="row">
                                            <div class="col-lg-9 fv-row">
                                                <input type="file" name="image" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"  autofocus />
                                            </div>
                                            <div class="col-lg-3 fv-row">
                                                <input type="text" name="text_alt" placeholder="resim alt etiketi" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"  autofocus />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Kulanılacak Anahtar Kelimeler</label>
                                    <div class="col-lg-8">
                                        <div class="row">
                                            <div class="col-lg-12 fv-row">
                                                <input class="tagify form-control" name='tags'  >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-bold fs-6">Paylaşım Tarihi</label>
                                    <div class="col-lg-8 fv-row">
