                                    ...
                                    <div class="tab-pane fade show active" id="kt_table_widget_5_tab_1">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
                                                ...
                                                <thead>
                                                <tr class="border-0">
                                                    <th class="p-0 min-w-150px">Link</th>
                                                    <th class="p-0 min-w-140px">Tarih</th>
                                                    <th class="p-0 min-w-140px">Durum</th>
                                                </tr>
                                                </thead>
                                                <!--end::Table head-->
                                                <!--begin::Table body-->
                                                <tbody>
                                                    ...
                                                    @foreach(\App\Models\indexAt::all() as $key => $value)
                                                        <tr>
                                                            <td>
                                                                <a href="{{$value['link']}}" target="_blank" class="text-dark fw-bolder text-hover-primary mb-1 fs-6">{{$value['link']}}</a>
